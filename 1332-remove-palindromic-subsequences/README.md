...
<pre style="position: relative;"><strong>Input:</strong> s = "ababa"
...
<pre style="position: relative;"><strong>Input:</strong> s = "abb"
...
<pre style="position: relative;"><strong>Input:</strong> s = "baabb"
<strong>Output:</strong> 2
